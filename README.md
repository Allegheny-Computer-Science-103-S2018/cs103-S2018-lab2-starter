...
# cs103-S2018-lab2-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Laboratory 2 in Computer Science 103. Since
...
headers, paragraphs, links, inline code segments, fenced code blocks, and a
table. Then, you will use a Markdown conversion tool, called
[Pandoc](https://pandoc.org/), to convert your Markdown to HTML and then run a
web server to provide local access to the static web site. For this laboratory
assignment, you will apply two cascading style sheets to your web site and
observe how they change, for instance, the colors and fonts on your site.
Finally, you will note the differences in the display of the Markdown on GitHub
and the web site created by your local server.
...
repository and that your writing contains the specified number of paragraphs.
...
To do well on this assignment, you should also review Chapters 1 and 2 of the
course textbook, paying close attention to Section 2.3 through 2.6, Figures 2.14
and 2.15, and Table 2.1. Please see the course instructor or one of the teaching
...
- The `answers.md` file has at least five subsections created with a `##`
  marker.
- The `answers.md` file has at least four fenced code blocks that have the
  correct beginning and ending symbols.
- The `answers.md` file contains six paragraphs.
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-103-S2018/cs103-S2018-lab2-starter.git
```
...
you can go to the [Computer Science 103 Lab 2
Starter](https://github.com/Allegheny-Computer-Science-103-S2018/cs103-S2018-lab2-starter)
